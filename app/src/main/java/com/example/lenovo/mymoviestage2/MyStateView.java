...
public class MyStateView extends RecyclerView {
    private static final String SAVED_SUPER_STATE = "super-state";
    private static final String SAVED_LAYOUT_MANAGER = "layout-manager-state";

    private Parcelable mLayoutManagerSavedState;
    public MyStateView(@NonNull Context context) {
        super(context);
    }

    public MyStateView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public MyStateView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyle) {
